...
public interface ShopCertificationContract {
    ...
    interface IShopCertifitionPressenter extends BasePresenter{
         ...
         */
        void siteAuth(String uSessionId,String invater,String siteName,String linkMan,String sitePro,
                      String siteCity,String siteAddress,String sitePic,String SiteCPic,String siteLPic,
                      String siteSPic,String cardPic,String authType);
